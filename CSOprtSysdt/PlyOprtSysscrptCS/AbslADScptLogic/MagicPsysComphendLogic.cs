...
//public class MagicPsysComphendLogic : NetworkBehaviour {
    ...
    {"Grant,StartDelay=false","Rend asunder,break through lim~"};
    ...
    [SerializeField] float PlyManipulationPower;
    [SerializeField] InputField Cast_SpellInput;
    [SerializeField] Text PlyCastSysAcknowledgedText;
    [SerializeField] Text PlyCastFinalActivationText;
    [SerializeField] ParticleSystem PlyPSysMainEffct;
    ...
    [SerializeField] ParticleSystem CstRecognisedActPSys;
    ...
    void Update () {
        //if(isLocalPlayer&&PlyManipulationPower>0)
        if(PlyManipulationPower>0)
        {
